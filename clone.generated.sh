...
clone_if_missing "inventory_service_api" "https://github.com/gorundebug/inventory_service_api.git" "v0.2.12"
clone_if_missing "model" "https://github.com/gorundebug/model.git" "v0.2.12"
clone_if_missing "order_service_api" "https://github.com/gorundebug/order_service_api.git" "v0.2.12"
