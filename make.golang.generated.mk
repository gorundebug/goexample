...
GO_SERVICES := analyticsservice inventoryservice orderservice
BUF_VERSION := v1.47.2
BUF := $(TOOLS_DIR)/buf
...
.PHONY: golang-build golang-test golang-lint golang-lint-fix golang-fmt \
	...
	gen-openapi docker-build-local-analyticsservice debug-analyticsservice docker-build-local-inventoryservice debug-inventoryservice docker-build-local-orderservice debug-orderservice
...
golang-gen: golang-gen-proto golang-gen-openapi golang-fmt go-mod-tidy ## Generate all Go transport code
