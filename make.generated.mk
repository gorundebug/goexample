...
git-push-inventory_service_api: $(GH) ## Push module inventory_service_api to github.com/gorundebug/inventory_service_api
	$(call git-push-dir,inventory_service_api,$(MODULE_VERSION),github.com,gorundebug/inventory_service_api)
...
git-push-order_service_api: $(GH) ## Push module order_service_api to github.com/gorundebug/order_service_api
	$(call git-push-dir,order_service_api,$(MODULE_VERSION),github.com,gorundebug/order_service_api)

git-delete-order_service_api: $(GH) ## Delete module order_service_api from remote
	@$(GH) repo delete gorundebug/order_service_api --yes 2>/dev/null || true


git-push-analyticsservice: $(GH) ## Push service Analytics Service to github.com/gorundebug/analyticsservice
	$(call git-push-dir,analyticsservice,$(MODULE_VERSION),github.com,gorundebug/analyticsservice,)

git-delete-analyticsservice: $(GH) ## Delete service Analytics Service from remote
	@$(GH) repo delete gorundebug/analyticsservice --yes 2>/dev/null || true


git-push-automationservice: $(GH) ## Push service Automation Service to github.com/gorundebug/automationservice
	$(call git-push-dir,automationservice,$(MODULE_VERSION),github.com,gorundebug/automationservice,)

git-delete-automationservice: $(GH) ## Delete service Automation Service from remote
	@$(GH) repo delete gorundebug/automationservice --yes 2>/dev/null || true


git-push-inventoryservice: $(GH) ## Push service Inventory Service to github.com/gorundebug/inventoryservice
	$(call git-push-dir,inventoryservice,$(MODULE_VERSION),github.com,gorundebug/inventoryservice,)

git-delete-inventoryservice: $(GH) ## Delete service Inventory Service from remote
	@$(GH) repo delete gorundebug/inventoryservice --yes 2>/dev/null || true


git-push-orderservice: $(GH) ## Push service Order Service to github.com/gorundebug/orderservice
	$(call git-push-dir,orderservice,$(MODULE_VERSION),github.com,gorundebug/orderservice,)

git-delete-orderservice: $(GH) ## Delete service Order Service from remote
	@$(GH) repo delete gorundebug/orderservice --yes 2>/dev/null || true


git-push-project: $(GH) ## Push project root to github.com/gorundebug/goexample
	$(call git-push-dir,.,$(MODULE_VERSION),github.com,gorundebug/goexample)

git-delete-project: $(GH) ## Delete project repository github.com/gorundebug/goexample
	@$(GH) repo delete gorundebug/goexample --yes 2>/dev/null || true
