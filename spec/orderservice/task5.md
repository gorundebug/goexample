...
| Language | `Go` |
| Kind | `map` |
| File | `orderservice/internal/functions/order/maptoorderprocessed.go` |
| Test | `orderservice/internal/functions/order/maptoorderprocessed_test.go` |
...
- [ ] Append to `spec/progress.md`: `- [x] orderservice/task5.md — MapToOrderProcessed — Go — done`